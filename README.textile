...
h2. This is how to use it New Bamboo

from the rails_apps_composer directory:

<pre>
rake print --silent RECIPES=jquery,haml,rspec,guard,action_mailer,devise,add_user,home_page,home_page_users,mysql,seed_database,users_page,css_setup,application_layout,html5,navigation,cleanup,ban_spiders,extras,git > ~/Somewhere/template.txt
</pre>

Then from wherever you want to place the project:
<pre>
rails new JellySnakes -d mysql -m ~/Somewhere/template.txt
</pre>
